...
به طور کلی این روش مشابه عملکرد یک **HTTP Proxy** است، اما به دلیل محدودیت‌هایی، تفاوت‌هایی در نحوه اجرا وجود دارد:
...
- **محدودیت در متد:**  
  شاید متد اصلی (مانند `OPTIONS`) روی هاست پشتیبانی نشود؛ پس باید قبل از ارسال، متد را مثلاً به `POST` تغییر دهیم
