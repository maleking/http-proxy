...
- **خستگیمون در بره :**  
  ما اینجا داریم زحمت میکشیم 😃 این کار حاصل 4 سال زمان فراغت و حدود 7000 خط کد هست که با انواع کتابخانه ها مثل walkor/workerman reactphp/reactphp پیاده سازی شد اما جواب نداد تا بالاخره بهترین راه رو پیدا کردم
- **بهترش کنیم :**  
